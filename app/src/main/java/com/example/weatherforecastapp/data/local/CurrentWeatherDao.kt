...
import com.example.weatherforecastapp.data.local.entity.CURRENT_WEATHER_BODY_P_KEY
import com.example.weatherforecastapp.data.local.entity.CurrentWeather
import com.example.weatherforecastapp.data.local.entity.PRIMARY_KEY_ID
